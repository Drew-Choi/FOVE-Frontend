  ...
  return (
    <>
      ...
      <div className="agreement">
        ...
        <br />
        <span>
          이 약관은 (주)포브(전자상거래 사업자)가 운영하는 FOVE(이하 “몰”이라
        ...
        <br />
        <span>
          &nbsp;&nbsp;① “몰”이란 (주)포브가 재화 또는 용역(이하 “재화 등”이라
        ...
        <span>
          ...
          이용자가 이해할 수 있도록 별도의 연결화면 또는 팝업화면 등을 제공하여
          이용자의 확인을 구하여야 합니다.
        </span>
        <br />
        <span>
        ...
        <span>
          ...
          있는 경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시
          미리 포괄적으로 동의를 받지 않습니다. 이 때 “몰”은 제공되는 개인정보
          항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유·이용 기간
          등을 구매자에게 명시하여야 합니다. 다만 「정보통신망이용촉진 및
          정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 처리위탁의 경우
        ...
        <br />
        <span>&nbsp;&nbsp;&nbsp;&nbsp;3. 온라인무통장입금</span> <br />
        <span>&nbsp;&nbsp;&nbsp;&nbsp;4. 전자화폐에 의한 결제</span> <br />
        <span>&nbsp;&nbsp;&nbsp;&nbsp;5. 수령 시 대금지급</span> <br />
        <span>
        ...
        <br />
        <br />
        <span>제21조(연결“몰”과 피연결“몰” 간의 관계)</span>
        <br />
        <span>
        ...
        <br />
        <br />
        <span>부 칙(시행일) 이 약관은 2021년 9월 10일부터 시행합니다.</span>
        <br />
        <br />
        ...
        <br />
        <span>
          “(주)포브”는 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡
          알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신
          경우에는 일반 문자메시지로 보내 드립니다. 카카오톡 알림톡을 통해
          안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡
          수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는
          알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기
          바랍니다.
        </span>
        <br />
        <br />
        <br />
        <span>-개인정보의 위탁 처리 </span>
        <br />
        <br />
        <span>#카카오톡 알림톡 시행에 관한 내용 </span>
        <br />
        <br />
        <span>
          “(주)포브”는 서비스 향상을 위해 관계법령에 따라 회원의 동의를 얻거나
          관련 사항을 공개 또는 고지 후 회원의 개인정보를 외부에 위탁하여
          처리하고 있습니다. “(주)포브”의 개인정보처리 수탁자와 그 업무의 내용은
          다음과 같습니다.
        </span>
        <br />
        <br />
